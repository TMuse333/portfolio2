    ...
    export const designAdvantages2 = [
      ...
      const cardGameDesc = [
        ...
        },
        {
          ...
          description:'There are different components in this game like the set of cards and the scoreboard that rely on the same useState variable like if the game has started or not. I had to create a context file to handle operations and logic that had to be shared throughout miltiple files to ens'
        }
      ]
