    ...
    export const designAdvantages2 = [
     ...
     export const hydrolistIntro1 = {
      ...
      export const q3Tactics = [
        ...
        {
          name:'tilting feature and slide in animations',
          description:'To enhance interactivity on the website, I implemented a tiliting feature on some of the components and made components '
        }
      ]
