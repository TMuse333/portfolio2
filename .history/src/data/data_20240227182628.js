      ...
      const cardGameDesc = [
        {
          ...
          description:'In this card game there are many states that one cycle of play has, so I got a very thoroug'+ understanding of how to think about each state and how they relate to one another what what operations to perform based on which state, and making sure each state is updated properly'
        },
        {
