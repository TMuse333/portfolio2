...
export const designAdvantages = [
    ...
    export const designAdvantages2 = [
      ...
      export const project1 =
      {
        ...
        A lot of game logic\n
        Making a mongodb server and then using node js to make api requests to send the scores to the database and retrieve it to display it on the leaderboard`,
