     ...
     export const hydrolistIntro1 = {
      ...
      export const q3Tactics = [
        ...
        },
        {
          ...
          description:'Most of the components have two distinct versions, one where the image and text are stacked on each other for mobile devices, and one where I use display flex with flex direction: row'
        }
      ]
