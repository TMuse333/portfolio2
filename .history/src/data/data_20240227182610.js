      ...
      const cardGameDesc = [
        {
          ...
          description:'In this card game there are many states that one cycle of play has, so I got a very thourough understanding of how to think about each state and how they relate to one another what what operations to perform based on which state, and making sure each state is updated properly'
        },
        {
          name:'Using context file',
          description:'There are different components in this game like the set of cards and the scoreboard that rely on the same useState variable like if the game has started or not. I had to create a context file to handle operations and logic that had to be shared throughout multiple files to ensure each file knows what'
        }
      ]
